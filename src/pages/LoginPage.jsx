  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 h-screen">
      <div className="flex flex-col justify-center items-center p-8 relative">
        <form onSubmit={handleSubmit} className="w-full max-w-md md:shadow-sm md:bg-gray-100 md:rounded-xl md:p-10 lg:shadow-none lg:rounded-none lg:bg-transparent lg:p-0">
          ...
          <div className="mt-6 flex flex-col items-center">
            <button
              type="button"
              className="flex items-center justify-center w-full bg-white border border-gray-300 text-black rounded-[12px] py-3 mb-4 shadow-sm transition duration-300 font-medium"
            >
              <svg
